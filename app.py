...
# --- CONFIGURACIÓN DE IA ---
# Usamos tu clave directamente
genai.configure(api_key="AIzaSyBGZ7-k5lvJHp-CaX7ruwG90jEqbvC0zXM")
...
st.title("🛡️ PROFEEDUCA: Generador Inteligente")
...
if submit:
    with st.spinner("🤖 La IA está redactando tu planeación pedagógica..."):
        # Usamos el modelo flash que es el más compatible actualmente
        model = genai.GenerativeModel('gemini-1.5-flash')
        
        prompt = f"""
        Actúa como un experto pedagogo CONAFE. Genera una planeación para {nivel} sobre {tema} en {comunidad}.
        Incluye: Marco teórico de 10 renglones, Pase de lista con 'Hipótesis rápida', Regalo de lectura 
        y procedimientos paso a paso para estaciones de Lenguajes, Saberes y Ética.
        """
